...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %PF Coils Cx
    r=linspace(0.6, 0.7, 5); %(distanciax, y, separacion cuadrados) respecto al centro%
z=linspace(1, 1.1, 5);
    [r, z]=meshgrid(r, z);
f=fiesta_filament(r(:)', z(:)', 0.02, 0.02);
upper_cx_coil=fiesta_coil('cx', f);

    r1=linspace(0.6, 0.7, 5);
z1=linspace(-1, -1.1, 5);
    [r1, z1]=meshgrid(r1, z1);
f1=fiesta_filament(r1(:)', z1(:)', 0.02, 0.02);
lower_cx_coil=fiesta_coil('cx',f1);
...
Rctrl=0.875; %Distancia del origen al centroide el plasma
actrl=0.3; %Radio del plasma promedio 
Zctrl=0.01; %Distancia entre el centroide y el eje horizontal
kappactrl=1.6; %Elongación 
deltactrl=-1; %Triangularidad
deltactrl2=0; %Segunda Triangularidad
